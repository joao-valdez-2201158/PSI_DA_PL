...
-- --------------------------------------------------
-- Date Created: 05/05/2021 18:29:38
-- Generated from EDMX file: C:\Users\jpval\Dropbox\PSI\2º_SEMESTRE\PROJETOS\PSI_DA_PL\app\DA_BooKids.edmx
-- --------------------------------------------------
...
GO
IF OBJECT_ID(N'[dbo].[FK_ColaboracaoAnimador]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[ColaboracaoSet] DROP CONSTRAINT [FK_ColaboracaoAnimador];
GO
...
-- Creating foreign key on [Cliente_IdPessoa] in table 'PessoaSet_Filho'
ALTER TABLE [dbo].[PessoaSet_Filho]
...
-- Creating foreign key on [Data] in table 'CompraSet'
ALTER TABLE [dbo].[CompraSet]
...
ALTER TABLE [dbo].[ColaboracaoSet]
ADD CONSTRAINT [FK_ColaboracaoAnimador]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_ColaboracaoAnimador'
CREATE INDEX [IX_FK_ColaboracaoAnimador]
